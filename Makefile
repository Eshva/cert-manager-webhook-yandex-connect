...
package:
	helm package deploy/cert-manager-webhook-yandex-connect -d charts/
	helm repo index charts/ --url https://eshva.github.io/cert-manager-webhook-yandex-connect
...
rendered-manifest.yaml:
	helm template \
        ...
        deploy/cert-manager-webhook-yandex-connect > "${OUT}/rendered-manifest.yaml"
